...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2020 at 01:39 PM
...
CREATE TABLE `attendence` (
  `id` int(10) NOT NULL,
  `class_info_id` int(10) NOT NULL,
  `subjects_id` int(10) DEFAULT NULL,
  `r_date` date NOT NULL,
  `r_time` varchar(127) NOT NULL
...
INSERT INTO `attendence` (`id`, `class_info_id`, `subjects_id`, `r_date`, `r_time`) VALUES
(1, 1, 2, '2020-06-29', '2:00 pm');
...
INSERT INTO `classstudents` (`id`, `class_info_id`, `students_id`, `description`) VALUES
(1, 1, 9, 'good');
...
CREATE TABLE `class_info` (
  `id` int(10) NOT NULL,
  `year_semester_id` int(10) DEFAULT NULL,
...
INSERT INTO `class_info` (`id`, `year_semester_id`, `name`, `description`) VALUES
(1, 1, 'class 12', 'class 12');
...
(1, 'Havard', 'USA', 'US', 'PArk', 'NY', '1212', 'uploads/images/company/download.png', '', '', 'footer content XXXXXXXXX XXXXXXX');
...
CREATE TABLE `payments` (
  ...
  `pay_subject` varchar(127) DEFAULT NULL,
...
INSERT INTO `payments` (`id`, `class_info_id`, `students_id`, `pay_subject`, `amount`, `pay_date`) VALUES
(1, 1, 2, NULL, NULL, '2020-06-29');
...
INSERT INTO `routine` (`id`, `class_info_id`, `subjects_id`, `teachers_id`, `r_date`, `r_time`) VALUES
(1, 1, 2, 0, '2020-06-29', '2:00 pm');
...
INSERT INTO `students` (`id`, `email`, `password`, `title`, `first_name`, `last_name`, `file_picture`, `phone_no`, `dob`, `company`, `address`, `city`, `state`, `zip`, `country_id`, `created_at`, `updated_at`, `user_type`, `status`) VALUES
...
INSERT INTO `teachers` (`id`, `email`, `password`, `title`, `first_name`, `last_name`, `file_picture`, `phone_no`, `dob`, `company`, `address`, `city`, `state`, `zip`, `country_id`, `created_at`, `updated_at`, `user_type`, `status`) VALUES
(9, 'xx@xx.com', 'xx', 'Mr.', 'John', 'Smith', NULL, NULL, NULL, '', '', '', '', '', '231', '2011-10-19 00:00:00', '2011-10-19 00:00:00', 'super', 'active');
...
(9, 'xx@xx.com', 'xx', 'Mr.', 'John', 'Smith', '', '', '0000-00-00', '', '', '', '', '', '231', '2011-10-19 00:00:00', '2020-06-29 13:31:46', 'super', 'active');
...
INSERT INTO `year_semester` (`id`, `name`, `description`) VALUES
(1, '2020 1st', '2020'),
(2, '2020 2nd', '2020 2nd');
...
ALTER TABLE `users`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `year_semester`
--
ALTER TABLE `year_semester`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
